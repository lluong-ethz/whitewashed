...
SMALL_TRAIN_NEG = 'twitter-datasets/train_neg.txt'
SMALL_TRAIN_POS = 'twitter-datasets/train_pos.txt'
TRAIN_NEG = 'twitter-datasets/train_neg_full.txt'
TRAIN_POS = 'twitter-datasets/train_pos_full.txt'
